...
await message.client.sendMessage(message.jid, fs.readFileSync('./uploads/Raju bhai.mp3'), MessageType.audio, s{ mimetype: Mimetype.mp4Audio, quoted : message.data, ptt: true})
Seddlet pattern = nseew RegExp(`\\b${a}\wb`, 'g');
